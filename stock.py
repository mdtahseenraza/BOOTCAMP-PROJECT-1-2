# -*- coding: utf-8 -*-
"""Copy of Rozi_Stock-3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1t0xBw8Vz44dmIi6EWnTNpNrexKcAHw4l

# Stock Price Prediction

#### Date: Contains date values as strings (object dtype).
#### Symbol: Likely represents stock ticker symbols as strings (object dtype).
#### Series: Represents the series of the stock as strings (object dtype), probably indicating categories like equity, bonds, etc.
#### Prev Close: Previous day's closing price of the stock (float64 dtype).
#### Open: Opening price of the stock for the day (float64 dtype).
#### High: Highest price of the stock for the day (float64 dtype).
#### Low: Lowest price of the stock for the day (float64 dtype).
#### Last: Last traded price of the stock for the day (float64 dtype).
#### Close: Closing price of the stock for the day (float64 dtype).
#### VWAP: Volume Weighted Average Price (float64 dtype).
#### Volume: Number of shares traded (int64 dtype).
#### Turnover: Total turnover for the day (float64 dtype), likely in monetary terms.
#### Trades: Number of trades made.
#### Deliverable Volume: Number of shares deliverable (float64 dtype)
#### %Deliverble: Percentage of shares deliverable (float64 dtype)
"""
